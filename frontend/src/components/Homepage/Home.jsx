  ...
  const changePriceOption1 = function (type) {
    ...
    setFilterWines1(
      wines
        .filter(
          (wine) =>
            wine.price >= searchOption[0] && wine.price < searchOption[1]
        )
        .slice(0, 16)
    );
    ...
    <>
      <div className="topList">
        <div className="header">
          <div className="headerTitle">Top lists in California</div>
          <div className="headerDesc">Updated every Thursday</div>
        </div>
        ...
        <div className="country-toplist">
          <div className="toplist-controls">
            <a
              className={
                "toplist-button icon1 " +
                (topListSelection1 === "$" ? "active" : "")
              }
              onClick={() => changePriceOption1("$")}
            ></a>
            <a
              className={
                "toplist-button icon2 " +
                (topListSelection1 === "$$" ? "active" : "")
              }
              onClick={() => changePriceOption1("$$")}
            ></a>
      ...
      <div className="topList">
        <div className="header">
          <div className="headerTitle">Top lists in USA</div>
          <div className="headerDesc">Updated every Thursday</div>
        </div>
        ...
        <div className="country-toplist">
          <div className="toplist-controls">
            <a
              className={
                "toplist-button icon5 " +
                (topListSelection2 === "$" ? "active" : "")
              }
              onClick={() => changePriceOption2("$")}
            ></a>
            <a
              className={
                "toplist-button icon6 " +
                (topListSelection2 === "$$" ? "active" : "")
              }
              onClick={() => changePriceOption2("$$")}
            ></a>
